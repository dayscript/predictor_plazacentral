        ...
        <div class="positions">
            <div class="row">
                <div class="small-3 small-offset-3 columns text-center">
                    ...
                    <div class="team" v-if="first.length">{{ first[0].short}}</div>
                ...
                <div class="small-3 columns end text-center">
                    ...
                    <div class="team" v-if="second.length">{{ second[0].short}}</div>
                    <div class="team" v-else>-</div>
                </div>
            </div>
        </div>
        <div class="teams">
            <div class="row">
                <div class="small-3 columns text-center" v-for="(list,index) in teams">
                    ...
                    <div class="team" v-if="list.length">{{ list[0].short }}</div>
                </div>
            </div>
        </div>
        <div class="social text-center" v-if="first.length && second.length">
            <social-sharing v-if="group.myprediction && group.myprediction.id" :url="'/predictions/'+group.myprediction.id" inline-template>
                <div>
