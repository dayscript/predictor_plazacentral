    ...
    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
        ...
        <div class="row padding-30">
            <div class="medium-9 columns">
                <div class="row">
                    <div class="columns medium-6"><p>@{{ $store.getters.trans('users.register_or_facebook') }}</p></div>
                    <div class="columns medium-6"><a href="/login/facebook" class="button facebook expanded"><i class="fab fa-facebook"></i> @{{ $store.getters.trans('users.facebook_connect') }}</a></div>
                </div>
                <hr>
                <div class="row">
